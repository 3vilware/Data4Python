...
class administrador():
	...
	def insertar(self,lista):
		self.c.execute("INSERT INTO usuario(nombre, apellido1, apellido2, correo, password, tipo) VALUES(?,?,?,?,?,?)", (lista[0], \
...
#admin = administrador()
#admin.insertar(['ricardo', 'amador', 'cast', 'r@hotmail.com', '12345', 0]) #lista
#db.close()